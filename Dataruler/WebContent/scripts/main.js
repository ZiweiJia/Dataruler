(function() {
  ...
  function init() {
    ...
    document.querySelector('#login-form-btn').addEventListener('click', onSessionInvalid);//给button绑定相对性的object
  ...
  function onSessionValid(result) {
    ...
    var loginForm = document.querySelector('#login-form');//选中所有的form
  ...
  function onSessionInvalid() {
    ...
    clearLoginError();
    showElement(loginForm);//出了loginform，其他的都隐藏
  }
